...
/**
 * {@link TypeSerializer} to check mutually exclusive thread access API to methods.
 */
@Internal
class SingleThreadAccessCheckingTypeSerializer<T> extends TypeSerializer<T> {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SingleThreadAccessCheckingTypeSerializer;
    }
    ...
    /**
     * {@link TypeSerializerSnapshot} for {@link SingleThreadAccessCheckingTypeSerializer}.
     */
